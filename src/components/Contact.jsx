    ...
    return (
        <div id="contact" className="container flex flex-col justify-center items-center bg-[#090909] rounded-[2rem] p-3 sm:p-6 md:p-6 lg:p-8 text-white">
            <div className="contact-container text-center my-5 sm:my-6 md:my-8 lg:my-10 ">
                ...
                <p className="text-[12px] sm:text-[14px] md:text-[18px] lg:text-[20px] xl:text-[24px] font-[400] text-[#707070] mt-2 sm:mt-3 md:mt-4">"Let’s bring your idea to life! Drop me a message and I’ll respond as soon as possible."</p>
            </div>
            <div className="contact-info-container flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                ...
                <div className="contact-info-links flex flex-col gap-2 sm:gap-3 text-xs sm:text-sm md:text-base lg:text-lg">
                    <p className="flex items-center justify-center gap-2">
                        <MdOutlineEmail className="text-xl sm:text-2xl md:text-3xl lg:text-4xl" style={{ filter: "drop-shadow(0 0 5px rgba(255,255,255,0.7)) drop-shadow(0 0 10px rgba(255,255,255,0.5))" }} /> Email Address:{" "}
                        <span className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-[1.5rem] px-1 sm:px-2">yahya.mostafa1219@gmail.com</span>
                    </p>
                    <p className="flex items-center justify-center gap-2">
                        <MdPhone className="text-xl sm:text-2xl md:text-3xl lg:text-4xl" style={{ filter: "drop-shadow(0 0 5px rgba(255,255,255,0.7)) drop-shadow(0 0 10px rgba(255,255,255,0.5))" }} /> Phone Number:{" "}
                        <span className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-[1.5rem]">+20 10 220 47280</span>
                    </p>
                </div>
            </div>
        </div>
